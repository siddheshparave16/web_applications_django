...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, username, email, organization, password=None, **extra_fields):
...
class TaskManagerUser(AbstractUser):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["organization", "username"], name="unique_username_per_organization"),
            models.UniqueConstraint(fields=["organization", "email"], name="unique_email_per_organization"),
        ]
