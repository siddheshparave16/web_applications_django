...
from accounts.forms import CustomUserCreationForm, TaskManagerUserUpdateForm  # Updated imports

class TaskManagerUserAdmin(UserAdmin):
    list_display = ('id', 'email', 'username', 'organization', 'is_superuser', 'is_staff', 'is_active')
