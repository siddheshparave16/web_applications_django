...
from .views import (TaskListView, TaskDetailView, TaskCreateView, TaskUpdateView, TaskDeleteView,
                    ...
                    epic_list_view, epic_detail_view, ContactFormView, manage_epic_tasks, SprintCreateView, SprintUpdateView,
...
urlpatterns = [
    ...
    path('tasks/sprint/add/<int:sprint_id>/', create_task_on_sprint, name='task-add-to-sprint'),
