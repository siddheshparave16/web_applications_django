...
def markdown_to_safe_html(markdown_text):
    ...
    # sanitize the html
    allowed_tags = ['pi', 'strong', 'em', 'ul', 'ol', 'li', 'a', 'br', 'code', 'pre', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6']

    allowed_attributes = {'a': ['href', 'title', 'ref']}
    allowed_protocols = ['http', 'https', 'mailto']

    safe_html = bleach.clean(html_content, tags=allowed_tags, attributes=allowed_attributes, protocols=allowed_protocols, strip=True)
